...
function mk3Sindel() { // MORTAL KOMBAT 3 - SINDEL
  ...
  document.getElementById("finishingMoves").innerHTML = 
  "<div class='moveName'>Fatality 1: Hair Spin</div> <br>"
  + "Run, Run, Block, Run, Block <div class='distance'>(Sweep)</div>"
  + "<br><br>"
  + "<div class='moveName'>Fatality 2: Super Sonic Scream</div> <br>"
...
function mk3Jax() { // MORTAL KOMBAT 3 - JAX
  ...
  + "<div class='moveName'>Back Breaker</div> <br>" 
  + "Block <i>(While in air near opponent)</i>" 
  ...
  + " Back + High Punch";
  document.getElementById("finishingMoves").innerHTML = 
  "<div class='moveName'>Fatality 1: Slicer</div> <br>"
  + "<i>(Hold Block)</i> Up, Down, Forward, Up <i>(Release Block)</i>"
  + "<div class='distance'> (Close)</div><br><br>"
  + "<div class='moveName'>Fatality 2: Giant Stomp</div> <br>"
...
function mk3Kano() { // MORTAL KOMBAT 3 - KANO
  ...
  + "<div class='moveName'>4 Hits</div> <br>" 
  + "High Kick, High Kick, Low Kick, Back + High Kick" 
  document.getElementById("finishingMoves").innerHTML = 
  "<div class='moveName'>Fatality 1: Skeleton Rip</div> <br>"
  + "<i>(Hold Low Punch)</i> Forward, Down, Down, Forward <i>(Release Low"
  + "Punch)</i> <div class='distance'>(Close)</div><br><br>"
  + "<div class='moveName'>Fatality 2: Eye Laser</div> <br>"
...
function mk3LiuKang() { // MORTAL KOMBAT 3 - LIU KANG
  ...
  + "Forward, Forward, High Kick <br><br>" 
  + "<div class='moveName'>Bicycle Kick</div> <br>" 
  + "<i>(Hold Low Kick)</i> 3 Seconds <i>(Release Low Kick)</i>" 
  ...
  document.getElementById("finishingMoves").innerHTML = 
  "<div class='moveName'>Fatality 1: Combustion</div> <br>"
  + "Forward, Forward, Down, Down, Low Kick"
  + "<div class='distance'> (Any)</div><br><br>"
  + "<div class='moveName'>Fatality 2: Arcade Drop</div> <br>"
  + "Up, Down, Up, Up, Block + Run" 
  + "<div class='distance'> (Any)</div><br><br>"
  + "<div class='moveName'>Animality</div> <br>"
  + "Down, Down, Up " 
  + "<div class='distance'> (Sweep)</div><br><br>"
...
function mk3SonyaBlade() { // MORTAL KOMBAT 3 - SONYA BLADE
  ...
  + "High Kick, High Kick, High Punch, High Punch, Low Punch, Back + High Punch"
  document.getElementById("finishingMoves").innerHTML = 
